...
const MESSAGES = Object.freeze({
   ...
   * @example
   * import { ERROR_MESSAGES, ERROR_KEYS } from 'ego'
   * 
   ...
   * console.log(messageFn({ label: 'Superfield', args: 5 })) 
   * // Superfield should be less than or equal 5
   * 
   */
   ...
   * // Superfield should be less than 10 and greater or equal 5
   * 
   */
   ...
   * // Superfield should contain only allowed keys: prop1, prop2
   * 
   */
   ...
   * console.log(messageFn({ label: 'Superfield', args: ['prop1', 'prop2'] })) 
   * // Superfield should has keys: prop1, prop2
   * 
   */
