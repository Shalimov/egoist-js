...
import { spec, validators, validateWithOpts, toValidatorWithArgs } from '../lib'

describe('Custom Validator Spec', () => {
	it('should create cross validator for object', () => {
		const customErrorKey = 'custom.key'
		const crossPropertyEqual = toValidatorWithArgs(customErrorKey, (crossPropName, value, { context }) => {
